...
public class DiagonalUpMaskTest {
    ...
    public void testGetWidth() throws Exception {
        DiagonalUpMask test = new DiagonalUpMask(9, 26);
    ...
    public void testGetLeftPadding() throws Exception {
        ...
        ArrayList<Integer> test = new DiagonalUpMask(9, 26).getLeftPadding();
    ...
    public void testGetLineLength() throws Exception {
        ...
        ArrayList<Integer> test = new DiagonalUpMask(9, 26).getLineWidth();
        for (int i = 0; i < expected.length; i++) {
            assertEquals(expected[i], (int) test.get(i));
        }
    }

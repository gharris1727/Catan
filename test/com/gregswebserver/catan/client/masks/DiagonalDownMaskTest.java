...
public class DiagonalDownMaskTest {
    ...
    public void testGetWidth() throws Exception {
        DiagonalDownMask test = new DiagonalDownMask(26, 9);
    ...
    public void testGetLeftPadding() throws Exception {
        ...
        ArrayList<Integer> test = new DiagonalDownMask(26, 9).getLeftPadding();
    ...
    public void testGetLineLength() throws Exception {
        ...
        ArrayList<Integer> test = new DiagonalDownMask(26, 9).getLineWidth();
        for (int i = 0; i < expected.length; i++) {

...
import com.gregswebserver.catan.client.masks.HexagonalMask;
...
public class HexagonalMaskTest {
    ...
    public void testGetLeftPadding() throws Exception {
        ...
        ArrayList<Integer> test = new HexagonalMask(56, 48).getLeftPadding();
    ...
    public void testGetLineLength() throws Exception {
        ...
        ArrayList<Integer> test = new HexagonalMask(56, 48).getLineWidth();
        for (int i = 0; i < expected.length; i++) {
            assertEquals(expected[i], (int) test.get(i));
        }
    }
